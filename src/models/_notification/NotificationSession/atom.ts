...
// 수신된 알림 메세지
export const receivedNotificationMessagesAtom = atom<NotificationMessageDto[]>({
    key: 'receivedNotificationMessagesAtom',
    default: [],
});

export const reloadNotificationQueryAtom = atom<number>({
    key: 'reloadNotificationQueryAtom',
    default: 0,
});
