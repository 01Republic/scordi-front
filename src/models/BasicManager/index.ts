...
export class BasicManager<DTO> {
    ...
    static init<DTO, Model extends BasicManager<DTO>>(this: ClassConstructor<Model>, list?: DTO[]): Model {
    ...
    reverse<Model extends BasicManager<DTO>>(this: Model): Model {
        const newList = [...this.list].reverse();
        return this.asManager<Model>(newList);
    }

    filter<Model extends BasicManager<DTO>>(
        this: Model,
    ...
    sort<Model extends BasicManager<DTO>>(this: Model, compareFn?: (a: DTO, b: DTO) => number): Model {
        const newList = [...this.list].sort(compareFn);
        return this.asManager<Model>(newList);
    }

    sortBy<Model extends BasicManager<DTO>>(
        this: Model,
    ...
    unique<Model extends BasicManager<DTO>>(this: Model, attr?: keyof DTO | ((record: DTO) => any)): Model {
        if (attr) {
            const seen: any[] = [];
    ...
    first<Model extends BasicManager<DTO>>(this: Model, count: number): Model {
        return this.filter<Model>((_, i) => i < count);
    }

    last<Model extends BasicManager<DTO>>(this: Model, count: number): Model {
    ...
    attrMap<Model extends BasicManager<DTO>, K extends keyof DTO>(this: Model, attr: K): DTO[K][] {
        return this.list.map((d) => d[attr]);
    }

    attrSum<Model extends BasicManager<DTO>, K extends keyof DTO>(this: Model, attr: K): number {
    ...
    protected asManager<Model extends BasicManager<DTO>>(this: Model, newList: DTO[]): Model {
