...
export const CardInfoSection = memo((props: CardInfoSectionProps) => {
    const {prevStep, register, isValid, watch, setFocus, errors} = props;
    ...
    return (
        <DPayPageLayout title="카드 정보를">
            <div className="flex flex-col h-full justify-between text-sm">
                <section className="flex flex-col gap-5">
                    <article className="flex flex-col">
                        <div className="flex gap-8 lg:gap-20 w-full">
                            <label key="개인카드" className="flex gap-1">
                                <input
                                    type="radio"
                                    key="개인카드"
                                ...
                                <p className="whitespace-normal">개인카드</p>
                            </label>
                            <label key="법인카드" className="flex gap-2">
                                <input
                                    type="radio"
                                    key="법인카드"
                                    className="mr-2 hidden"
                        ...
                        <div className="lg:mt-1 h-2 mb-4">
                            {cardType === '법인카드' && (
                                <p className="text-gray-400 ">개인 명의의 법인 카드일 경우 개인 카드로 등록해주세요</p>
                            )}
                        </div>
                    </article>
