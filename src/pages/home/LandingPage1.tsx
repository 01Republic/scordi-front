          ...
          <section id="section-1" className="hero mb-3">
            <div className="hero-content text-center">
              <div className="">
                ...
                <div className="py-6">
                  <TypeFormBtn campaignKey={CampaignKeys.landingV1} id="cta-1">무료로 시작하기</TypeFormBtn>
                </div>
              </div>
            </div>
          </section>
        ...
        <section id="section-6-1">
          <div className="container pt-16 pb-12 text-center">
            ...
            <div className="pt-12 pb-6">
              <TypeFormBtn campaignKey={CampaignKeys.landingV1} id="cta-2">사전 신청 등록하기</TypeFormBtn>
            </div>
          </div>
