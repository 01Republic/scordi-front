...
export const OrgSubscriptionSelectPageRoute = pathRoute({
    pathname: '/orgs/[id]/subscriptions/select',
    path: (orgId: number) => pathReplace(OrgSubscriptionSelectPageRoute.pathname, {id: orgId}),
});
