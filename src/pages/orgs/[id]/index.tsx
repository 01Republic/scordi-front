...
import {
  ContentPanel,
  ContentPanelInput,
  ContentPanelItem, ContentPanelItemTitle, ContentPanelItemText, ContentPanelList,
} from '^layouts/ContentLayout/ContentPanel';
import { useForm } from 'react-hook-form';
import { OrganizationDto, UpdateOrganizationRequestDto } from '^types/organizationTypes';
...
export default function OrgShowPage() {
  ...
  const UpdateOrgHandler = (dto: UpdateOrganizationRequestDto) => {
    updateOrganization(org.id, dto).then(res => {
        ...
        <ContentPanel title="General">
          <ContentPanelList>
            ...
            >
              <TextInput
                required={true}
                {...generalForm.register('slug', { required: true, value: org.slug })}
              />
            </ContentPanelInput>
            ...
            >
              <TextInput
                required={true}
                {...generalForm.register('name', { required: true, value: org.name })}
              />
            </ContentPanelInput>
        ...
        <ContentPanel title="memberships">
          <ContentPanelList>
            ...
            >
              <TextInput
                required={true}
                {...membershipsForm.register('name', { required: true, value: org.name })}
              />
            </ContentPanelInput>
          </ContentPanelList>
        </ContentPanel>
      ...
      <ContentPanel title="Remove Organization">
        <ContentPanelList>
          <ContentPanelItem>
            ...
            <div className="flex-1">
              <button className="btn btn-error text-white">Remove Organization</button>
            </div>
          </ContentPanelItem>
        </ContentPanelList>
      </ContentPanel>
