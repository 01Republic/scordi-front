...
export const OrgReviewUncategoriedPageRoute = pathRoute({
    pathname: '/orgs/[id]/reviewUncategorized',
    path: (orgId: number) => pathReplace(OrgReviewUncategoriedPageRoute.pathname, {id: orgId}),
});
