...
export default function OrgMembershipIndexPage() {
    ...
    const inviteLink = `${typeof window !== 'undefined' && window.location.origin}/signup/${org.id}`;
    ...
    return (
        <>
            <InviteMemberModal inviteLink={inviteLink} isModalOpen={isModalOpen} setIsModalOpen={setIsModalOpen} />
            <ContentLayout>
...
function InviteMemberModal({inviteLink, isModalOpen, setIsModalOpen}: InviteMemberModalProps) {
    return (
        <Modal
            type={'info'}
            isOpen={isModalOpen}
