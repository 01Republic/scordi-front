...
interface BusinessTypeSectionForSubscriptionProps {
    isPersonal: boolean;
    setIsPersonal: (value: boolean) => void;
}

export const BusinessTypeSectionForSubscription = memo(({ isPersonal, setIsPersonal }: BusinessTypeSectionForSubscriptionProps) => {
    return (
...
BusinessTypeSectionForSubscription.displayName = 'BusinessTypeSectionForSubscription';
