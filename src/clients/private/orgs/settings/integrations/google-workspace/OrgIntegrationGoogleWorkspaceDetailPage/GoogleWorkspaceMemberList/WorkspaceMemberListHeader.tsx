...
export const WorkspaceMemberListHeader = memo((props: WorkspaceMemberListHeaderProps) => {
        ...
        <div className="py-3 px-6 bg-gray-100/50 border-b border-gray-200">
            <div className="flex items-center justify-between">
                <div className="flex items-center">
                    <div className="font-semibold text-12">MEMBERS in google workspace ❤️</div>
...
WorkspaceMemberListHeader.displayName = 'WorkspaceMemberListHeader';
