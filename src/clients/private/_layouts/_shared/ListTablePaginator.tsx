...
export const ListTablePaginator = memo((props: ListTablePaginatorProps) => {
    const {pagination, prevButtonClick, nextButtonClick, onChangePerPage, unit = '개'} = props;
    ...
    return (
        <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-2">
                ...
                <select
                    ...
                    onChange={(e) => {
                        ...
                        return onChangePerPage && onChangePerPage(num);
                    }}
                >
            ...
            <div className="flex items-center gap-2">
                <PageButton onClick={prevButtonClick} disabled={pagination.currentPage <= 1}>
                    <FaChevronLeft fontSize={14} />
                    <span>이전</span>
                </PageButton>

                <PageButton onClick={nextButtonClick} disabled={pagination.totalPage <= pagination.currentPage}>
                    <span>다음</span>
