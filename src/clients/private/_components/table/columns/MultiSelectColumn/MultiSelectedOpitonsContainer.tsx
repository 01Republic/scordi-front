...
interface MultiSelectedOpitonsContainerProps<T> {
    selectedOptions: T[];
...
export const MultiSelectedOpitonsContainer = <T,>(props: MultiSelectedOpitonsContainerProps<T>) => {
...
MultiSelectedOpitonsContainer.displayName = 'MultiSelectedOpitonsContainer';
