        ...
        <>
            ...
            {!(ButtonComponent || children) && (
                <button
                    ...
                    } btn btn-lg btn-outline shadow font-medium normal-case space-x-4 bg-white border-gray-150 text-gray-700 hover:bg-white hover:border-primary hover:text-slate-700 focus:bg-scordi-50 active:bg-primary-100`}
                >
                    <img
