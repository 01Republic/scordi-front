...
노션으로 계정 정리하고 있었는데 멤버들이 늘어나면서 쓰는 것도 많아지고 관리가 안돼서 힘들었어요. 지금 필요한 서비스에요. SaaS 관리에 필요한 추가 기능이 앞으로 더 생기면 정말 환상적일 것 같아요.`}
                />
                <ReviewItem
                    duration={750}
                    reviewer="박태훈"
                    ...
                    title="오! 대박이다! 어떻게 클릭 한 번에 서비스랑 결제내역이 보여질 수 있나요?"
                    content={`저희는 SaaS 관리는 팀 매니저들이 하고, 구독결제는 오퍼레이션팀에서 관리하고 있어요. 스코디가 저희 운영팀의 문제를 해결해 줄 수 있겠네요. 진짜 최곤거같아요.`}
                />
                <ReviewItem
                    duration={1000}
                    reviewer="최현일"
                    ...
                    title="처음엔 'SaaS, 해봤자 얼마나 쓰겠어' 생각했어요."
                    content={`스코디로 연동해서 보니 실제로 SaaS에 생각했던 것보다 더 많이 돈 쓰고 있더라고요. 인원이 많아지면 비용도 커질텐데, 스코디로 미리 낭비 될만한 건 방지할 수 있을 것 같아요. 덕분에 SaaS 쓰면서 필요 이상으로 많이 쓰던 비용도 아꼈어요.`}
                />
            </div>
