...
import {EnumPropertyFormData, SelectedPatternMethod} from '^models/EmailParser/types';
...
export const TargetPropertyEnumItemContent = (
    props: TargetPropertyItemContentProps<EnumPropertyFormData<BillingCycleOptions>>,
) => {
    const {
        emailItem,
        content,
