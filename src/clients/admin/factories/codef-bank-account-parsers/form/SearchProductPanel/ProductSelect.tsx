...
import {SearchedProductItem} from '^admin/factories/codef-bank-account-parsers/form/SearchProductPanel/SearchedProductItem';
...
export const ProductSelect = memo((props: ProductSelectProps) => {
    ...
    const {result, isLoading} = useSearchProductInCodefBankAccountParser();
