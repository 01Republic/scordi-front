...
import {GyuridTable, useColumnDefs, useDefaultColDef, useSortColumns, useVisibleColumns} from '^lib/GyuridTable';
...
export const AdminScordiPlanListPage = memo(function AdminScordiPlanListPage() {
    ...
    const [columnDefs, setColumnDefs] = useColumnDefs<ScordiPlanDto>([
        ...
        {field: 'regularPrice', headerName: '정가', onSort, cellType: {name: 'number', format: 'currency'}},
