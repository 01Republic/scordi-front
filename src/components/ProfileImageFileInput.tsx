...
export const ProfileImageFileInput: FC<ProfileImageFileInputProps> = ({
  imageUrl,
  fallbackLetter,
  onChange,
}) => {
  ...
  return (
    <div className="relative w-fit">
      ...
      >
        ...
        <div className={`${isHover ? '' : 'hidden'} absolute bottom-0 w-full h-fit bg-[#00000080] rounded-b text-center text-white font-bold flex items-center justify-center py-1`}>
