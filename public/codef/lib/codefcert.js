...
var codefcert = {
    ...
    _logger:
        typeof console == 'object'
            ...
            : {
              ...
              }, // FIXME Deprecated : use _log() instead of _logger.console.log.
    _socket: null,
    _iframe: null,
    ...
    engineVersion: function (call_back) {
        ...
        if (call_back && typeof call_back === 'function') {
            if (!this._listener['codefcert_getVersion']) this._listener['codefcert_getVersion'] = [];
    ...
    engineGetCertification: function (drive, call_back) {
        ...
        if (call_back && typeof call_back === 'function') {
            if (!this._listener['codefcert_getCertification']) this._listener['codefcert_getCertification'] = [];
    ...
    engineGetExternalDrive: function (call_back) {
        ...
        if (call_back && typeof call_back === 'function') {
            if (!this._listener['codefcert_getExternalDrive']) this._listener['codefcert_getExternalDrive'] = [];
    ...
    engineGetDevice: function (infoKey, call_back) {
        ...
        if (infoKey) {
            ...
            if (call_back && typeof call_back == 'function') {
                if (!this._listener['codefcert_getDeviceInfo']) this._listener['codefcert_getDeviceInfo'] = [];
    ...
    engineCheckLicense: function (call_back) {
        ...
        if (call_back && typeof call_back === 'function') {
            if (!this._listener['codefcert_checkLicense']) this._listener['codefcert_checkLicense'] = [];
