...
curl -X POST -H 'Content-type: application/json' --data '{"text":"Deploy:Staging Success"}' https://hooks.slack.com/services/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
